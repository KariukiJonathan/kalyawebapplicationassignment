...
function coverflowimages(options){
	...
	var preloadimages = ["AUDI A4.jpg","AUDI.jpg","DODGE CHALLENGER.jpg","MUSTANG.jpg","bmw.jpg","LAMBOGINI.jpg"]
...
$(document).ready(function() {
	coverflowimages({
		coverid: 'coverflow1',
		images: [
							['passport.jpeg', 'passport.jpeg', 'NAME : KALYA MITCHELLE <br> REG NO : SCT221-0441/2021'],
							...
							['LAMBOGINI.avif', 'LAMBOGINI.avif', 'Lambigini Matador 2009 model Price 23400 usd CIF Mombasa'],
							['AUDI.jpg', 'AUDI.jpg', 'Audi R8 coupe 2013 model Price 17000 usd CIF Mombasa'],
							['AUDI A4.jpg', 'AUDI A4.jpg', 'Audi A4 2011 model Price 11500 usd CIF mombasa'],
							['DODGE CHALLENGER1.jpg', 'DODGE CHALLENGER.jpg','The Dodge Chellenger 1999 model price 15000 usd CIF mombasa'] // <-- no comma after last image
						] 
	})
	});